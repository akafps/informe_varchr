...
1. [Claude]"Oye, estoy armando un proyecto con Vite y React desde CMD pero PowerShell me tira un error de políticas de ejecución de scripts y no me deja levantar el entorno. ¿Cómo lo soluciono rápido sin romper los permisos de Windows?"
